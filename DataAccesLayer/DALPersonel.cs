...
namespace DataAccesLayer
{
    public class DALPersonel
    {
        ...
        {
            SqlCommand komut2 = new SqlCommand("insert into TBLBİLGİ (AD,SOYAD,GOREV,SEHIR,MAAS) VALUES (@P1,@P2,@P3,@P4,@P5)", Baglanti.bgl);
        ...
        {
            SqlCommand komut4 = new SqlCommand("Update TBLBİLGİ set AD=@P1,SOYAD=@P2,GOREV=@P3,SEHIR=@P4,MAAS=@P5 where ID=@P6", Baglanti.bgl);
